<div class="col-12 d-flex justify-content-center align-items-center event" data-item="day-3">
    <div class="mt-3 dynamic p-5">
        <div class="left">
            <span class="d-flex justify-content-start align-items-center color-a size-3">
                <i class="ri-calendar-event-fill"></i>&nbsp;
                <span class="size-7 color-g">Oct 26, 2023</span>
            </span>
            <span class="d-flex justify-content-start align-items-center color-a size-3">
                <i class="ri-time-line"></i>&nbsp;
                <span class="size-7 color-g">10:00 AM - 05:00 PM</span>
            </span>
            <span class="d-flex justify-content-start align-items-center color-a size-3">
                <i class="ri-map-2-line"></i>&nbsp;
                <span class="size-7 color-g">Adisaptagram, Hoogly</span>
            </span>
            <span class="d-flex justify-content-start align-items-center color-a size-3">
                <i class="ri-home-6-line"></i>&nbsp;
                <span class="size-7 color-g">Auditorium</span>
            </span>
        </div>
        <div class="mid">
            <span class="size-3 color-a">Conference Topic 3</span>
