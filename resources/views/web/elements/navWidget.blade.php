{{-- <div class="navigation" data-visible="false">
    <div class="row">
        <div class="col-12 d-flex justify-content-between align-items-center mx-4">
        ...
        <div class="col-12 mx-4 page">
            ...
            <div class="foot-alg mt-3">
                ...
                <a class="foot-link font-2"><span class="foot-list" data-bs-toggle="collapse" href="#collapseExample"
                ...
                <div class="collapse" id="collapseExample">
                    <div class="bg-transparent foot-alg px-5 py-2">
                        ...
                        <a class="color-a font-2 foot-link py-1" href="{{ url('/call-for-paper') }}">Call for Paper</a>
        ...
        <div class="col-12 head-list up-pad mx-4">
