...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('appStyles/global.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('appStyles/header.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('appStyles/home.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('appStyles/footer.css') }}">
    {{-- ------------------------------------------------------------------- --}}
    {{-- SWIPER SLIDER-CDN --}}
    {{-- ------------------------------------------------------------------- --}}
